                    ...
                    <div class="w-full flex-col justify-center items-start gap-8 flex">
                        <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                            <h2
                                ...
                                Specialized Maintenance & Cleaning for Oil & Gas Facilities</h2>
                            <p class="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                               We deliver expert maintenace and cleaning services tailored for the oil and gas industry. Including tube bundle cleaning, heat exchanger inspection and restoration, pipeline diagnostics, and mechanical overhails. Our team ensures maximum equipment performance, safety compliance, and operational reliability across every phase of your project.</p>
                        </div>
